...
- Superviseur principal `[Accred. 4]`
    - Le superviseur principal répartira les enquêtes entre les superviseurs et contrôlera la qualité des preuves recueillies. Il possédera l'autorité nécessaire pour engager une procédure contre un directeur de département, mais uniquement avec un niveau de preuve renforcé.
- Superviseur `[Accred. 4]`
    - Le superviseur dirigera une mission ou une enquête précise. Il pourra envoyer des agents sur le terrain pour analyser une installation, surveiller un membre du personnel ou vérifier une situation jugée sensible.
- Agent expérimenté `[Accred. 4]`
    - L'agent expérimenté pourra être désigné responsable de déploiement. Il encadrera les agents moins expérimentés, organisera les interventions sur le terrain et pourra arrêter du personnel non dirigeant lorsqu'une infraction sera constatée.
- Agent `[Accred. 3]`
